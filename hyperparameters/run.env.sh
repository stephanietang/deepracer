DR_MODEL_PREFIX=s11
DR_RUN_ID=0
DR_WORLD_NAME=jyllandsringen_open
...
DR_LOCAL_S3_MODEL_PREFIX=training/$DR_WORLD_NAME/$DR_MODEL_PREFIX
DR_LOCAL_S3_PRETRAINED=False
DR_LOCAL_S3_PRETRAINED_PREFIX=model-pretrained
DR_LOCAL_S3_PRETRAINED_CHECKPOINT=last
DR_LOCAL_S3_CUSTOM_FILES_PREFIX=custom_files/$DR_WORLD_NAME/$DR_MODEL_PREFIX
...
DR_UPLOAD_S3_PREFIX=upload/$DR_WORLD_NAME/$DR_MODEL_PREFIX
DR_REGULAR_UPLOAD=0
...
DR_CONTINUE_ON_SPOT_INTERRUPTION=True