...
class Reward:
    ...
    def reward_function(self, params):
        ...
        if self.verbose == True:
            ...
            printStr = ("REWARD: {:3.4f}, DIS_REW: {:3.4f}, DIST: {:3.4f}, DIR_REW: {:3.4f}, DIR_DIFF: {:3.4f}, CLOSET_INDEX: {}").format(
                reward, distance_reward, dist, direction_reward, direction_diff, closest_index)
            print(printStr)
