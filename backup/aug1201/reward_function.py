...
class Reward:
    ...
    def reward_function(self, params):
        ...
        def get_projected_time(first_index, closest_index, step_count):
            ...
            if self.verbose:
                self.logger.info("first_index: %i" % first_index)
    ...
    #################### RACING LINE ######################
        ...
        # straight_reward = get_straight_reward()
        ...
        speed_reward = get_speed_reward3()
        reward += speed_reward

        # progress_reward = get_progress_reward()
        ...
        if self.verbose == True:
            ...
            printStr = ("REWARD: {:3.5f}, DIST_REW: {:3.5f}, DIR_REW: {:3.5f}, SPEED_REW: {:3.5f}, DIST: {:3.5f}, DIR_DIFF: {:3.6f}, CLOSET_INDEX: {}").format(
                reward, distance_reward, direction_reward, speed_reward, dist, direction_diff, closest_index)
            # printStr = ("REWARD: {:3.5f}, SPEED_REW: {:3.5f}, DIST_REW: {:3.5f}, CLOSET_INDEX: {}").format(
            #     reward, speed_reward, distance_reward, closest_index)
...
reward_object = Reward(verbose=False, debug=False, output_log=False)
